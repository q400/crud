...
<%
'************************************************************************************
'* 화면명	: notice_v.asp - 공지사항
'************************************************************************************
	Call checkLevel(USER_AUTH, 900, Request.ServerVariables("PATH_INFO"))

	bbs_id						= 100							'100-공지/200-인사발령/300-자료/400-사진자료/500-브리핑
	...
	If seq = "" Then
		Call noAlertGo("notice.asp?page="& page &"&"& pageParam)
	End If
	...
	If flag <> "W" and cid <> USER_COMP Then Call AlertGo("정보가 없습니다.", "/bbs/notice.asp")
